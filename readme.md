...
- **Plně AJAXové rozhraní**: Prakticky veškerá interakce v aplikaci probíhá bez obnovování stránky. **Nastavení** (sekce, barvy, AI, Inbox) se ukládají bleskově a okamžitě při změně přepínače, což se ihned promítne do navigace i statistik, což zajišťuje špičkový uživatelský zážitek a bleskovou odezvu. Tato modernizace se týká i přepínání témat či správy štítků.
