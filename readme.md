...
- **Integrace AI (Gemini & OpenAI)**: DevBase využívá sílu umělé inteligence od Google i OpenAI pro usnadnění vaší práce. Funkce jsou dostupné po zadání API klíče v Nastavení:
  ...
  - **Konfigurace**: V nastavení si můžete zvolit **preferovaného poskytovatele (Gemini / OpenAI)** a konkrétní model (např. GPT-4o nebo Gemini 2.0 Flash) a otestovat platnost klíčů. Všechny AI prvky jsou v UI barevně odlišeny (fialová s premium glow efektem).
