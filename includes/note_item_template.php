        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-start mb-2">
                ...
                <div class="d-flex gap-2 delete-btn-wrapper" onclick="event.stopPropagation()">
                    <button type="button" class="btn btn-sm btn-link <?php echo $note['is_pinned'] ? 'text-warning' : 'text-white-50'; ?> p-0" 
                            onclick="toggleNotePin(<?php echo $note['id']; ?>, event)"
                    ...
                    <button type="button" class="btn btn-sm btn-link text-warning p-0" 
                            onclick="archiveNote(<?php echo $note['id']; ?>, event)"
                            title="Archivovat">
                        <i class="bi bi-archive"></i>
                    </button>
                    <button type="button" class="btn btn-sm btn-link text-danger p-0" 
                            onclick="deleteNote(<?php echo $note['id']; ?>, event)"
                            title="Smazat">
